...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // アニメーション対象要素
    const animateElements = document.querySelectorAll('.feature, .target-card, .timeline-item, .example-card, .faq-item, .organizer-profile');
    ...
    // カードのホバーエフェクト強化
    const cards = document.querySelectorAll('.target-card, .example-card, .feature');
